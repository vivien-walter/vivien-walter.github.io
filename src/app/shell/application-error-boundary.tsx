  ...
  public render(): ReactNode {
    ...
    return (
      <main id="main-content" className="bg-background text-foreground relative isolate min-h-screen min-h-svh">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[clamp(18rem,42vw,32rem)] bg-[linear-gradient(135deg,color-mix(in_srgb,var(--brand-primary)_7%,transparent),transparent_55%),linear-gradient(45deg,transparent_58%,color-mix(in_srgb,var(--brand-accent)_6%,transparent))]"
        />
