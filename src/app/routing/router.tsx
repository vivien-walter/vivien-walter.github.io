  ...
  return (
    <Routes>
      <Route element={<AppShell />}>
        ...
        <Route path={getPageRoute('experience', 'fr')} element={<ExperiencePage />} />
        <Route path={getDetailRoutePattern('experience', 'fr')} element={<ExperienceDetailPage />} />
        ...
        <Route path={getPageRoute('experience', 'en')} element={<ExperiencePage />} />
        <Route path={getDetailRoutePattern('experience', 'en')} element={<ExperienceDetailPage />} />
        ...
        <Route path="/" element={<Navigate replace to={getPageRoute('home', 'fr')} />} />
