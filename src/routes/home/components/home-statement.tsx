...
import type { HomeStatementContent } from "../data/home-statement-content.types";
  ...
  return (
    <aside
      className={cn(
        ...
        "bg-white/7 px-6 py-8",
        "sm:px-8 sm:py-9 lg:px-10 lg:py-10",
        "text-white",
      )}
    >
      <div
        className={cn(
          "grid gap-6",
          "lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center lg:gap-8",
        )}
      >
        <div
          className={cn(
