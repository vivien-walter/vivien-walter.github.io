...
import type { PublicationResourceContent } from "../data/publication-content.types";
              ...
              >
                ...
                >
                  ...
                  <span className="min-w-0">
                    <span
                      className={cn(
                        "block font-bold leading-heading",
                        "text-brand-ink",
                        "transition-colors duration-200",
                    ...
                    <span
                      className={cn(
                        "mt-3 block text-sm leading-body",
