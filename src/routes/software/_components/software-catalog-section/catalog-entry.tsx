  ...
  return (
    <li className="m-0 min-w-0">
      <article className="min-w-0" aria-labelledby={headingId}>
        <InteractiveCard
          interaction="self"
          className="group border-border-strong bg-brand-background shadow-subtle focus-within:border-brand-primary focus-within:bg-action-soft/70 focus-within:shadow-elevated focus-within:ring-brand-primary/30 gap-0 overflow-hidden rounded-lg py-0 focus-within:ring-2"
        >
