...
function ParallelActivityDetailPage() {
  ...
  const projectIds =
    "projectIds" in activity
      ? activity.projectIds
      : [];

  const softwareIds =
    "softwareIds" in activity
      ? activity.softwareIds
      : [];

  const publicationIds =
    "publicationIds" in activity
      ? activity.publicationIds
      : [];
  ...
  const relatedSoftware =
    softwareIds.flatMap((softwareId) => {
  ...
  "lg:pt-16 lg:pb-16",
      ...
      >
        ...
        <ExperienceDirectContributionsSection
          idPrefix={idPrefix}
          items={
            "directContributions" in
            activity
              ? activity.directContributions
              : undefined
          }
          title={
            page.parallelActivityDetail
        ...
        <DetailTechnologiesSection
          ...
          groups={
            "technologyGroups" in activity
              ? activity.technologyGroups
              : undefined
          }
          idPrefix={idPrefix}
          title={
