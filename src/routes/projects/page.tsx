...
} from "./_components/project-controls";
...
function ProjectsPage() {
  ...
  const projects = useMemo(
    () =>
      getProjectCollection(language).map(
  ...
  const visibleProjects = useMemo(() => {
    ...
    return projects
      ...
      .sort((first, second) => {
        const firstDate =
          first.project.period.start;

        const secondDate =
          second.project.period.start;
        ...
        switch (sortBy) {
          ...
          case "name-descending":
            comparison =
              second.project.title.localeCompare(
                first.project.title,
                locale,
                {
                  sensitivity: "base",
          ...
          <ProjectControls
            ...
            labels={{
              sortLabel:
                controls.sortLabel,
              sortPlaceholder:
                controls.sortPlaceholder,
              sortByDateDescending:
                controls.sortByDateDescending,
              sortByDateAscending:
                controls.sortByDateAscending,
              sortByNameAscending:
                controls.sortByNameAscending,
              sortByNameDescending:
                controls.sortByNameDescending,
              filters: controls.filters,
              filterByProject:
                controls.filterByProject,
              filterByLanguage:
                controls.filterByLanguage,
              clearFilters:
