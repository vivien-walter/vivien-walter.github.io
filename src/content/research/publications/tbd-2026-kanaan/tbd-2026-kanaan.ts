...
import enTbd2026Kanaan from './tbd-2026-kanaan.en.json';
import frTbd2026Kanaan from './tbd-2026-kanaan.fr.json';

export const natureMolecularCommunication2023Id = 'nature-molecular-communication-2023' as const satisfies PublicationId;
...
export function getNatureMolecularCommunication2023Content(language: SupportedLanguage) {
  const localized = selectLocalizedContent(localizedNatureMolecularCommunication2023Content, language);
